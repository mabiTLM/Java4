...
public class BoardDAOJdbc implements BoardDAO {
  ...
  public RowMapper<Board> mapper = new RowMapper<Board>() {
    @Override
    public Board mapRow(ResultSet rs, int rowNum) throws SQLException {
      return new Board(rs.getInt("id"), rs.getInt("user_id"), rs.getString("title"),
  ...
  public Board get(int id) {
    return jdbcTemplate.queryForObject("select * from boards where \"id\"=?", new Object[] {id},
        mapper);
  }
