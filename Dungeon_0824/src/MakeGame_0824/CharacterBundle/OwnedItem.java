...
public class OwnedItem
{
	...
	public OwnedItem[] itemDatabase()//모든 아이템목록
	{
		...
		totalItem[6] = new OwnedItem("낡은 지팡이","무기","지팡이", 3, 1000,"낡은 지팡이 : 무기, 지팡이, 공격력 3, 가격 1000");
		...
		totalItem[9] = new OwnedItem("평범한 지팡이","무기","지팡이", 5, 5000,"평범한 지팡이 : 무기, 지팡이, 공격력 5, 가격 5000");
		...
		totalItem[12] = new OwnedItem("마력의 지팡이","무기","지팡이", 7, 10000,"마력의 지팡이 : 무기, 지팡이, 공격력 7, 가격 10000");
		...
		totalItem[22] = new OwnedItem("흑요석 검","무기","검", 150, 50000,"흑요석 검 : 무기, 검, 공격력 150, 가격 50000");
		totalItem[23] = new OwnedItem("떡갈나무 지팡이","무기","지팡이", 20, 50000,"떡갈나무 지팡이 : 무기, 지팡이, 공격력 20, 가격 50000");
	...
	{	
		...
		buyItem[7] = new OwnedItem("낡은 지팡이","무기","지팡이", 3, 1000,"낡은 지팡이 : 무기, 지팡이, 공격력 3, 가격 1000");
		...
		buyItem[13] = new OwnedItem("평범한 지팡이","무기","지팡이", 5, 5000,"평범한 지팡이 : 무기, 지팡이, 공격력 5, 가격 5000");
		buyItem[14] = new OwnedItem("가죽 갑옷","갑옷",30, 5000,"가죽 갑옷 : 방어구, 방어력30 가격5000");
		
		buyItem[15] = new OwnedItem("강철 검","무기","검", 50, 10000,"강철 검 : 무기, 검, 공격력 50, 가격10000");
		buyItem[16] = new OwnedItem("마력의 지팡이","무기","지팡이", 7, 10000,"마력의 지팡이 : 무기, 지팡이, 공격력 7, 가격 10000");
		buyItem[17] = new OwnedItem("철 갑옷","갑옷",50, 10000,"철 갑옷 : 방어구, 방어력50 가격10000");
		
		buyItem[18] = new OwnedItem("흑요석 검","무기","검", 150, 50000,"흑요석 검 : 무기, 검, 공격력 150, 가격 50000");
		buyItem[19] = new OwnedItem("떡갈나무 지팡이","무기","지팡이", 20, 50000,"떡갈나무 지팡이 : 무기, 지팡이, 공격력 20, 가격 50000");
		buyItem[20] = new OwnedItem("미스릴 갑옷","갑옷",300, 50000,"미스릴 갑옷 : 방어구, 방어력300 가격 50000");
